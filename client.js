// Imgur CLIENT ID
const CLIENT_ID = '44067a004a4bf6d';
let callbacks = {};
...
function getMugshotUrl( ped, cb ) {
	...
	setTimeout(() => {
		...
		setTimeout(async() => {
			// Screenshot the screen using screenshot-imgurl
			let promise = new Promise(( resolve ) => {
				exports['screenshot-imgurl'].requestScreenshotUpload(`https://api.imgur.com/3/image`, 'imgur', {
					headers: {
